...
import { StatusBadge, UrlCopyBar } from '$lib/components/shared'
...
import { ArrowLeft, Check, Clock, Download, FileText, Search, Settings, X } from 'lucide-svelte'
  ...
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center gap-4">
      ...
      <div class="flex flex-wrap items-center gap-2">
        <UrlCopyBar label="CFP" path="/cfp/{data.edition.slug}" />
        <UrlCopyBar label="Submissions" path="/cfp/{data.edition.slug}/submissions" />
      </div>
