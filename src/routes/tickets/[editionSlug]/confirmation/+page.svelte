...
<div class="mx-auto max-w-2xl space-y-8">
	...
	<div class="text-center">
		{#if isPaid}
			...
			<h1 class="mt-4 text-3xl font-bold tracking-tight">Order Confirmed</h1>
			<p class="mt-2 text-muted-foreground">
				Your tickets have been sent to <strong>{data.order.email}</strong>
			</p>
		{:else if isPending}
			<div
			...
			<h1 class="mt-4 text-3xl font-bold tracking-tight">Payment Processing</h1>
			<p class="mt-2 text-muted-foreground">
				Your payment is being processed. You'll receive your tickets by email shortly.
			</p>
		{:else}
			<div
			...
			<h1 class="mt-4 text-3xl font-bold tracking-tight">Order #{data.order.orderNumber}</h1>
			<p class="mt-2 text-muted-foreground">
	...
	<Card.Root>
		<Card.Header>
			...
			<Card.Description>Order #{data.order.orderNumber}</Card.Description>
		</Card.Header>
	...
	{#if data.tickets.length > 0}
		<div class="space-y-4">
			...
			<p class="text-sm text-muted-foreground">
				Present these QR codes at the entrance for check-in.
			</p>
